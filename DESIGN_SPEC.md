...
- Sub-header: fixed, left 200px, top 48px, height 48px, 
  border-bottom 1px solid rgba(10,10,10,0.08)
  Contains: page title left, search center
- Content: margin-left 200px, padding-top 96px (48+48)
...
- Height: 48px, padding 14px 32px 12px
- Title: font-size 24px, font-weight 700, color #0A0A0A
- Subtitle: font-size 13px, color rgba(10,10,10,0.4), right-aligned

### Buttons
- Primary: background #E03553, color white, border-radius 999px,
  padding 8px 20px, font-size 13px, font-weight 600
- Secondary: background transparent, border 1px solid rgba(10,10,10,0.15),
  color #0A0A0A, border-radius 999px, padding 8px 20px, font-size 13px
