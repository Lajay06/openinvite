 ...
 *
 * Reads the same env vars the frontend already uses (src/lib/currencyPricing.js,
 * used by Pricing.jsx / PlanSelection.jsx) — the VITE_ prefix only controls
 * client bundling, Vercel functions can read them same as any other env var.
 */
