...
export default function HavanaSectionMark({ kicker, theme, typography, textColor, accentColor, as: Tag = 'p' }) {
  ...
  return (
    <div data-oi-anchor-root="" style={{ textAlign: 'left', marginBottom: 48 }}>
      {kicker && (
        <Tag data-oi-anchor="mark" className="wb-body-face" style={{ fontFamily: typography.bodyFont, fontSize: 12.5, fontWeight: 600, letterSpacing: '0.12em', color, opacity: 0.7, margin: '0 0 14px' }}>
          {kicker}
        </Tag>
      )}
