...
// 1664 is the master's real width from fl_getinfo (1664x2496).
const PHOTO = responsivePhoto("pin_edinburgh_couple", 1664);
    ...
    >
      ...
      >
        <div style={{ maxWidth: 552 }}>
          ...
          <p ref={bodyRef} className="feature-body-text" style={{ ...featureBodyTextStyle, color: "rgba(255,255,255,0.4)", marginBottom: 32 }}>
      ...
      {/* Photo — RIGHT, parallax zoom */}
       ...
       >
         <img
           ...
           srcSet={PHOTO.srcSet}
           sizes={PHOTO_SIZES}
           alt="A couple wrapped in a tartan blanket sharing a cone of chips above a city at dusk"
           style={{
             position: "absolute",
             inset: 0,
             width: "100%",
