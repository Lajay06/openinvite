...
export default function FeatureInvitations({ onCTA }) {
  ...
  // Derived values
  const overlayOpacity = lerp01(progress, 0, 1.0);          // black fade: 0→1 across full scroll
  const textOpacity    = 1 - lerp01(progress, 0, 0.3);      // text out: 1→0 over first 30%

  return (
    <section style={{ position: 'relative', background: '#0A0A0A' }}>

      {/* ── 300vh scroll driver ── */}
      <div ref={scrollContainerRef} style={{ position: 'relative', height: '150vh' }}>
