...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Car,     label: "Getting here",      url: "/transport" },
      { icon: Hotel,   label: "Stay",              url: "/accommodation" },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Hotel,      label: "Stay",            url: createPageUrl("GuestSuiteAccommodation") },
      { icon: Car,        label: "Getting here",    url: createPageUrl("GuestSuiteTransport") },
