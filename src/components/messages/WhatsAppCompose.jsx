    ...
    <Sheet open onOpenChange={(open) => { if (!open) onClose(); }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: 24, display: 'flex', flexDirection: 'column', gap: 18 }}>
        ...
        {/* WHAT THE GATE USED TO IMPLY, SAID PLAINLY (owner ruling, Run 5 T9).
            ...
            from that number. It does not: it opens WhatsApp and the
            message goes from whichever account is signed in there.
        ...
        <div data-whatsapp-send-note style={{ background: '#F5F5F5', padding: '10px 12px', fontSize: 12, color: '#444444', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          Opens in WhatsApp — messages send from the account you&rsquo;re signed in to.
        </div>
