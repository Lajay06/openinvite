    ...
    <div className="w-full max-w-2xl text-center">
      ...
      >
        <button
          ...
          disabled={uploading}
          className="px-8 py-3 rounded-full text-white text-sm font-medium tracking-widest bg-gradient-to-r from-[#E03553] to-[#803D81] hover:bg-none hover:bg-black hover:text-white active:bg-neutral-900 transition-colors duration-150 disabled:opacity-50"
        >
