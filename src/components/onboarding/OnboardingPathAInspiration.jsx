    ...
    <div className="w-full max-w-2xl text-center">
      ...
      >
        <button
          ...
          disabled={uploading}
          className="px-8 py-3 rounded-full text-white text-sm font-medium uppercase tracking-widest bg-gradient-to-r from-[#E03553] to-[#803D81] hover:brightness-110 transition-all disabled:opacity-50"
        >
