                        ...
                        <div key={task.id} style={{
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 3 }}>
                              {task.priority && (
                                <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 8px', borderRadius: 999, background: task.priority === 'high' ? 'rgba(224,53,83,0.1)' : 'rgba(10,10,10,0.06)', color: task.priority === 'high' ? '#E03553' : '#444444', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                  {task.priority}
                                </span>
                              )}
                              {task.due_date && (
