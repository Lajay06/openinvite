...
export const FEATURES = [
  ...
  { key: 'suite-schedule', group: 'suite', label: 'Schedule', icon: Clock, desktop: '/GuestSuiteSchedule', path: 'suite-schedule', kind: 'custom', depth: 'view', stat: (d) => count(d.schedule, 'event') },
  { key: 'qna', group: 'suite', label: 'Q&A', icon: HelpCircle, desktop: '/QandA', path: 'qna', kind: 'custom', depth: 'full', stat: (d) => count(d.details?.qna, 'question') },
  { key: 'suite-registry', group: 'suite', label: 'Registry', icon: Gift, desktop: '/GuestSuiteRegistry', path: 'registry', kind: 'custom', depth: 'full', stat: (d) => `${n(d.registryItems) + n(d.registryProducts) + n(d.customGifts)} on the site` },
  { key: 'suite-accommodation', group: 'suite', label: 'Accommodation', icon: Hotel, desktop: '/GuestSuiteAccommodation', path: 'suite-accommodation', kind: 'custom', depth: 'light', stat: (d) => count(d.details?.guestSuiteAccommodation?.places, 'place') },
  { key: 'suite-transport', group: 'suite', label: 'Transport', icon: Car, desktop: '/GuestSuiteTransport', path: 'suite-transport', kind: 'custom', depth: 'light', stat: (d) => count(d.details?.guestSuiteTransport?.places, 'place') },
  { key: 'experience', group: 'suite', label: 'Experience guide', icon: MapPin, desktop: '/GuestSuiteExperience', path: 'experience', kind: 'custom', depth: 'light', stat: (d) => count(d.details?.experienceGuide?.places, 'place') },
