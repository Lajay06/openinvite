...
export const FEATURES = [
  ...
  { key: 'suite-accommodation', group: 'suite', label: 'Accommodation', icon: Hotel, desktop: '/GuestSuiteAccommodation', path: 'suite-accommodation', image: imageUrl('tileSuiteAccommodation'), kind: 'custom', depth: 'light', stat: (d) => count(d.details?.guestSuiteAccommodation?.places, 'place') },
  { key: 'suite-transport', group: 'suite', label: 'Transport', icon: Car, desktop: '/GuestSuiteTransport', path: 'suite-transport', image: imageUrl('tileSuiteTransport'), kind: 'custom', depth: 'light', stat: (d) => count(d.details?.guestSuiteTransport?.places, 'place') },
