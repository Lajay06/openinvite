...
export const DETAILS = {
  ...
  accommodation: {
    ...
    sections: [
      ...
      { title: 'Notes', segment: 'notes', key: 'accommodation', fields: [ta('additionalNotes', 'Additional notes on where to stay', { placeholder: 'Anything else guests should know about where to stay' })] },
    ],
  },
  emergency: {
