...
export function vendorFields() {
  return [
    ...
    t('website', 'Website', { placeholder: 'A link, or just the name', autoCapitalize: 'off' }),
    ...
    t('meeting_date', 'Meeting date and time', { type: 'datetime', showIf: isPhotoOrVideo }),
    ...
    t('portfolio_url', 'Portfolio', { placeholder: 'A link, or where to see their work', autoCapitalize: 'off', showIf: isPhotoOrVideo }),
