...
export const IMAGES = {
  ...
  keepPlanning1: { id: 'DTS_SOFT_LUXE_Daniel_Farò_Photos_ID10822_kqgeik', alt: 'Hurrying along with a wrapped bouquet', usedIn: 'Home, keep planning card 1', screen: 'home', size: { w: 240, h: 180 }, ratio: '4/3' },
  ...
  tilePolls: { id: 'hf_20260903_232125_e3d26c1d-ea6a-4374-9443-107018d470f2_fn7vuc', alt: 'A leap from the rocks into the sea', usedIn: 'Plan hub, Polls & games tile', screen: 'plan', size: { w: 171, h: 148 }, ratio: '4/3', focal: '50% 35%' },
  tileMessages: { id: 'hf_20260904_090923_faab7fc5-e634-424b-95b7-39315dccbcf3_qe3lsz', alt: 'Laughing together in a blue doorway', usedIn: 'Plan hub, Messages tile', screen: 'plan', size: { w: 171, h: 148 }, ratio: '4/3', focal: '50% 40%' },
  ...
  tileSuiteSchedule: { id: 'DTS_MAKESHIFT_Julien_Tell_Photos_ID14037_hmxgml', alt: 'Getting ready, curlers in and phone in hand', usedIn: 'Plan hub, guest suite Schedule tile', screen: 'plan', size: { w: 171, h: 148 }, ratio: '4/3' },
  ...
  /* ── The daily update (goal 7, re-cast in goal 8): seven photos bundled into the app at build time (src/mobile/assets/daily/<day>.webp,
     800 by 800 WebP, downloaded from app/ during development and committed) so the takeover's photo is on screen with no loading gap.
     Rotated by the day of the week (shell/dailyPhotos.js). Goal 8's test: people facing the camera, faces whole, eyes open, warm and
     candid, no backs turned. The app/ pool had one photo that passed (the helmets); the other six were moved here from the slots they
     held, and those slots took the best of the unused pool. These seven count as used and appear nowhere else. ── */
  dailyMon: { id: 'hf_20260903_230909_75ff5eec-e9d1-46cf-95d2-5867030db959_hqk13n', alt: 'Two in helmets, seen through a car window', usedIn: 'Daily update, Mondays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'mon' },
  dailyTue: { id: 'DTS_Young_Latin_Martin_Pisotti_Photos_ID6999_p6ixxt', alt: 'Two friends in a portrait', usedIn: 'Daily update, Tuesdays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'tue' },
  dailyWed: { id: 'hf_20260904_010212_e9bf35e3-c220-4d78-8595-01d39c75be7e_se9wle', alt: 'Laughing together on a leather banquette', usedIn: 'Daily update, Wednesdays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'wed' },
  dailyThu: { id: 'hf_20260904_090213_dcaa917a-e117-4610-8618-a399139999a4_jv74kl', alt: 'Pulling faces in a photo booth', usedIn: 'Daily update, Thursdays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'thu' },
  dailyFri: { id: 'DTS_SNOWBOUND_Daniel_Farò_Photos_ID12430_hmrv0c', alt: 'A couple under a yellow blanket with mugs', usedIn: 'Daily update, Fridays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'fri' },
  dailySat: { id: 'hf_20260917_161857_658d1c99-742d-4bba-930c-4d52299b90c9_ccpphs', alt: 'On a green phone at a party', usedIn: 'Daily update, Saturdays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'sat' },
  dailySun: { id: 'DTS_LUNAR_Daniel_Farò_Photos_ID11268_bm3gla', alt: 'Side by side at dusk by the water', usedIn: 'Daily update, Sundays', screen: 'daily', size: { w: 390, h: 380 }, ratio: '1/1', bundled: 'sun' },
  ...
  placeMarket1: { id: 'DTS_SILVER_HOUR_Franco_Dupuy_Photos_ID14693_qexopz', alt: 'Choosing tulips at a flower market', usedIn: 'Demo: marketplace result 1, the photographer', screen: 'marketplace', size: { w: 72, h: 72 }, ratio: '1/1' },
