...
/** Flat loading blocks. kind: 'text' | 'title' | 'row' | 'block'. */
...
/** A list of row skeletons inside a white block. */
export function SkeletonRows({ count = 4 }) {
  return (
    <div className="oi-m-block oi-m-block--flush" aria-busy="true">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="oi-m-row" style={{ gap: 12 }}>
          <Skeleton kind="row" style={{ width: 40, height: 40 }} />
