      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div className="hidden md:block" style={{ width: '42%', flexShrink: 0, position: 'relative', overflow: 'hidden', background: '#0A0A0A' }}>
          ...
          <div style={{ position: 'absolute', left: 32, bottom: 28, right: 32 }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.7)', margin: '0 0 4px' }}>
              ...
              <>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <h1 style={{ fontSize: 'clamp(28px, 3.6vw, 42px)', fontWeight: 700, color: '#0A0A0A', margin: '0 0 16px', lineHeight: 1.1 }}>
                      {step.title}
                    </h1>
  ...
  return (
    <div style={{ marginTop: 40, paddingTop: 32, borderTop: '1px solid rgba(10,10,10,0.12)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 18 }}>
        ...
        <p style={{ fontSize: 11, fontWeight: 700, color: 'rgba(10,10,10,0.6)', margin: 0 }}>
          What Ultra adds
        </p>
      </div>
...
function CelebrationOverlay({ firstName, onDone }) {
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} style={{ paddingTop: 40 }}>
      <p style={{ fontSize: 12, fontWeight: 700, color: '#E03553', margin: '0 0 12px' }}>
        Milestone
      </p>
      <h1 style={{ fontSize: 'clamp(30px, 4.4vw, 48px)', fontWeight: 700, color: '#0A0A0A', margin: '0 0 16px', lineHeight: 1.1 }}>
