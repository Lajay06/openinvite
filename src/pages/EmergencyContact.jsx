...
function AvaModal({ onClose }) {
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent hideClose title="Ask Ava — emergency contacts" aria-label="Ask Ava — emergency contacts" className="max-w-[520px] max-h-[80vh] p-0 gap-0 flex flex-col">
