...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Send invites and track RSVPs from your guest list — invites, replies, and meal choices all live together there.',
    action: 'Open guest list',
  ...
  },
  {
    ...
    desc: 'Guest responses, meal choices, and personal messages show up in the same guest list, per guest and per event.',
    action: 'Open guest list',
    href: createPageUrl('Guests'),
    comingSoon: false,
  },
