  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF', fontFamily: PJS }}>
      ...
      <AvaModal
        ...
        systemPrompt="You are Ava, helping a couple write the questions and answers their guests read on the wedding website. Prefer the questions guests actually ask — travel, timing, dress code, children, parking — and answer in the couple's own plain voice, a sentence or two each."
