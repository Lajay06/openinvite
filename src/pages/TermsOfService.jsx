    ...
    <div style={{ background: '#FFFFFF', minHeight: '100vh' }}>
      ...
      <main style={{ paddingTop: 120, paddingBottom: 120 }}>
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px' }}>
          ...
          <p style={P}>OpenInvite offers a free trial and two paid, <strong>one-time-payment</strong> plans — Pro ($79 AUD / $59 USD) and Ultra ($149 AUD / $79 USD) — each giving 24 months of access from purchase. These are not recurring subscriptions: you are charged once, at checkout, and are not billed again for that plan.</p>
